...
public class Item {
	...
	private static final String createTableItem = "CREATE TABLE Item" + "(UPC int not null," + "title char(30)," 
												...
												+ "year char(5)," + "price float," + "stock int," + "PRIMARY KEY(UPC))";
	...
	private static final String CreateItemSequence =
			 ...
			 private static final String DropItemSequence =
	...
	public void showItem (Connection connect)
	{
		...
		public void insertItem (Connection connect, int upc, String titl,
				String typ, String catagor, String compan, String yea, float pric, int stoc)
		
		{
			...
			try {
				p = connect.prepareStatement("INSERT INTO Item VALUES (?,?,?,?,?,?,?,?)");
...
=======
>>>>>>> 6bd2b5853fb1f926b6c801fde272b68ebfd8b5b1
