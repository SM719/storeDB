...
public class Purchase {
	...
	private static final String createTablePurchase = "CREATE TABLE Purchase"
			+ "(receiptID int not null," + "date34 Date," + "CID int not null,"
			+ "card# char(30)," + "expiryDate Date," + "expectedDate Date,"
			+ "deliveredDate Date," + "PRIMARY KEY(receiptID),"
	...
	public void insertPurchase(Connection connect, int CID, String Cardnum,
			Date expireDate, Date expectedDate, Date deliveredDate) {
		PreparedStatement p;
		int cid = CID;
